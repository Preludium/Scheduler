...
import pl.jansmi.scheduler.dbstructure.daos.LocalizationDao;
...
@androidx.room.Database(entities = {Arrangement.class, Category.class, Discipline.class, Ingredient.class,
                                    Invitation.class, Localization.class, Meal.class, Measure.class,
                                    Practice.class, Study.class, Tag.class, Target.class, Task.class,
...
public abstract class Database extends RoomDatabase {
    ...
    public abstract LocalizationDao localizations();
